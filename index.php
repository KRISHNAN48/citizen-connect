...
<head>
    <title>District Care - Be Connected!</title>
...
<body>
    <div class="slider-thumb">
        ...
        <section class="navigation">
            <div class="nav-container">
                <div class="brand">
                    <h1 class="from-left-and-back">District Care</h1>
                </div>
                <nav class="nav-head">
    ...
    <footer>
        <p class="footer">© <span id="currentYear"></span> District Care. All rights reserved.</p>
    </footer>
